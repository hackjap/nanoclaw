...
- **Global scope**: `/Users/spjang/workspace/nanoclaw/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/spjang/workspace/nanoclaw/.claude/notes/`)
...
2. Glob `/Users/spjang/workspace/nanoclaw/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/spjang/workspace/nanoclaw/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/spjang/workspace/nanoclaw/.claude/notes/` — works in any directory
